...
const FEATURED = [
  ...
  {
    name: 'MyBevo',
    subtitle: 'AI Assistant for UT Austin',
    desc: 'Comprehensive AI assistant for UT Austin students. A resume genie that generates, analyzes, and ranks resumes across colleges — plus a chatbot that answers any university question, from dining menus to room availability.',
    tags: ['Node.js', 'React', 'Tailwind', 'JavaScript', 'OpenAI'],
    github: '#',
    live: null,
    emoji: '🤠',
    badge: 'In Progress',
...
const MORE = [
  ...
  },
  {
    ...
    desc: 'Built a fully-functional programming language from scratch just to see if I could. Custom lexer, parser, and interpreter in Python.',
    tags: ['Python', 'Compilers', 'Side Project'],
    github: '#',
    link: null,
    emoji: '⚙️',
  },
