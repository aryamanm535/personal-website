    ...
    >
      ...
      <div className="max-w-3xl w-full mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-14">
          ...
          {/* Photo — left */}
          <div className="hero-photo-wrap flex-shrink-0" style={{ animation: 'fadeIn 0.8s ease 0.2s both' }}>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h1
              ...
              style={{
                fontSize: 'clamp(2.4rem, 7vw, 4rem)', lineHeight: 1.05, letterSpacing: '-0.03em',
            ...
            {/* ECE label */}
            <p className="font-semibold text-base mb-4" style={{ color: 'var(--accent-bright)', letterSpacing: '0.01em', animation: 'slideUp 0.6s ease 0.25s both' }}>
              ECE @ UT Austin
            </p>

            {/* Typewriter */}
            <div className="flex items-center justify-center md:justify-start gap-0 mb-5 h-7" style={{ animation: 'slideUp 0.6s ease 0.38s both' }}>
            ...
            <p className="text-sm leading-relaxed mb-8 max-w-md mx-auto md:mx-0"
              style={{ color: 'var(--text-muted)', lineHeight: '1.75', animation: 'slideUp 0.6s ease 0.5s both' }}>
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-8"
              style={{ animation: 'slideUp 0.6s ease 0.62s both' }}>
              <button
            ...
            <div className="flex items-center justify-center md:justify-start gap-3"
              style={{ animation: 'slideUp 0.6s ease 0.74s both' }}>
